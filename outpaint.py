...
def main():
    ...
    callbacks = [EarlyStopping(monitor='val_loss', patience=70),
                 ModelCheckpoint(filepath='best_model70_withgray_finetuned.h5', monitor='val_loss',
                                 save_best_only=True),
...
def out_painting_mask(batch_x):
    ...
    for i in range(0, batch_x.shape[0]):
        ...
        out_paint_x[i][0:h, 0:224, :] = 0.5
        out_paint_x[i][224 - h:224, 0:224, :] = 0.5
        out_paint_x[i][0:224, 0:w, :] = 0.5
        out_paint_x[i][0:224, 224 - w:224, :] = 0.5
